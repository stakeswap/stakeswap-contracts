...
contract Constants {
    ...
    function DAI() public view returns (IERC20) {
        if (block.chainid == 1) return IERC20(0x6B175474E89094C44Da98b954EedeAC495271d0F);
    ...
    function USDC() public view returns (IERC20) {
        if (block.chainid == 1) return IERC20(0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48);
