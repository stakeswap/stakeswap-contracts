...
contract Constants {
    ...
    function WETH() public view returns (WETHInterface) {
        if (block.chainid == 1 || block.chainid == 1888) return WETHInterface(payable(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2));
    ...
    function DAI() public view returns (IERC20) {
        if (block.chainid == 1 || block.chainid == 1888) return IERC20(0x6B175474E89094C44Da98b954EedeAC495271d0F);
        if (block.chainid == 5) return IERC20(0x73967c6a0904aA032C103b4104747E88c566B1A2);
        revert('unknown chain id');
    }
    ...
    function USDC() public view returns (IERC20) {
        if (block.chainid == 1 || block.chainid == 1888) return IERC20(0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48);
        if (block.chainid == 5) return IERC20(0x2f3A40A3db8a7e3D09B0adfEfbCe4f6F81927557);
        revert('unknown chain id');
    }
    ...
    function stETH() public view returns (ST_ETH) {
        if (block.chainid == 1 || block.chainid == 1888) return ST_ETH(payable(0xae7ab96520DE3A18E5e111B5EaAb095312D7fE84));
    ...
    function wstETH() public view returns (WST_ETH) {
        if (block.chainid == 1 || block.chainid == 1888) return WST_ETH(payable(0x7f39C581F595B53c5cb19bD0b3f8dA6c935E2Ca0));
    ...
    function frxETH() public view returns (IERC20) {
        if (block.chainid == 1 || block.chainid == 1888) return IERC20(0x5E8422345238F34275888049021821E8E08CAa1f);
    ...
    function sfrxETH() public view returns (SFRX_ETH) {
        if (block.chainid == 1 || block.chainid == 1888) return SFRX_ETH(0xac3E018457B222d93114458476f3E3416Abbe38F);
    ...
    function frxETHMinter() public view returns (FrxETHMinter) {
        if (block.chainid == 1 || block.chainid == 1888) return FrxETHMinter(payable(0xbAFA44EFE7901E04E39Dad13167D089C559c1138));
    ...
    function rETH() public view returns (R_ETH) {
        if (block.chainid == 1 || block.chainid == 1888) return R_ETH(payable(0xae78736Cd615f374D3085123A210448E74Fc6393));
    ...
    function BalancerV2Vault() public view returns (BalancerV2VaultInterface) {
        if (block.chainid == 1 || block.chainid == 1888)
            return BalancerV2VaultInterface(payable(0xBA12222222228d8Ba445958a75a0704d566BF2C8));
    ...
    function BalancerV2_wstETH_WETH_POOL_ID() public view returns (bytes32) {
        if (block.chainid == 1 || block.chainid == 1888) return 0x32296969ef14eb0c6d29669c550d4a0449130230000200000000000000000080;
        revert('unknown chain id');
    }

    function BalancerV2_rETH_ETH_POOL_ID() public view returns (bytes32) {
        if (block.chainid == 1 || block.chainid == 1888) return 0x1e19cf2d73a72ef1332c882f20534b6519be0276000200000000000000000112;
        revert('unknown chain id');
    }
    ...
    function Curve_stETH_ETH_POOL_ADDRESS() public view returns (address) {
        if (block.chainid == 1 || block.chainid == 1888) return 0xDC24316b9AE028F1497c275EB9192a3Ea0f67022;
        revert('unknown chain id');
    }
    ...
    function Curve_stETH_ETH_POOL_TOKEN_INDEX_ETH() public view returns (int128) {
        if (block.chainid == 1 || block.chainid == 1888) return 0;
        revert('unknown chain id');
    }

    function Curve_stETH_ETH_POOL_TOKEN_INDEX_stETH() public view returns (int128) {
        if (block.chainid == 1 || block.chainid == 1888) return 1;
        revert('unknown chain id');
    }

    function Curve_stETH_ETH_POOL_LP_TOKEN_ADDRESS() public view returns (address) {
        if (block.chainid == 1 || block.chainid == 1888) return 0x06325440D014e39736583c165C2963BA99fAf14E;
        revert('unknown chain id');
    }

    function Curve_frxETH_ETH_POOL_ADDRESS() public view returns (address) {
        if (block.chainid == 1 || block.chainid == 1888) return 0xa1F8A6807c402E4A15ef4EBa36528A3FED24E577;
        revert('unknown chain id');
    }
    ...
    function Curve_frxETH_ETH_POOL_LP_TOKEN_ADDRESS() public view returns (address) {
        if (block.chainid == 1 || block.chainid == 1888) return 0xf43211935C781D5ca1a41d2041F397B8A7366C7A;
        revert('unknown chain id');
    }
}
