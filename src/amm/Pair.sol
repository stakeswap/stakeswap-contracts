// Pair implementation based on UniswapV2Pair
...
// TODO: check flash load resistance
// TODO: gas optimize
contract Pair is IPair, LP, Constants {
    ...
    uint256 public stakedWETHAmount; // amount of WETH staked to Staking contract
    ...
    modifier onlyStaking() {
        require(msg.sender == staking, 'NO_AUTH');
        _;
    }
    ...
    function onStake(uint256 lp) external onlyStaking returns (uint256 ethAmount) {
        ...
        require(token0IsWETH || token1IsWETH, 'INVALID_PAIR');
    ...
    function initialize(address _token0, address _token1, address _staking) external {
