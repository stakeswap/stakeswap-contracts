...
export interface RocketPoolAdaptorInterface extends utils.Interface {
  functions: {
...
export interface RocketPoolAdaptor extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RocketPoolAdaptorInterface;
